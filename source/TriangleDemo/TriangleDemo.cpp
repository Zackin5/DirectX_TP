...
namespace Rendering
{
    ...
    shaderFlags |= D3DCOMPILE_SKIP_OPTIMIZATION;
        ...
        {
            BasicEffectVertex(XMFLOAT4(-1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.5f, 0.6f, 0.05f, 1.0f)),
            BasicEffectVertex(XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.6f, 0.4f, 0.2f, 1.0f)),
            BasicEffectVertex(XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.4f, 0.7f, 0.5f, 1.0f))
        };
